...
int main( int argc, char** argv )
{
	...
	cout << "SO(3) form matrix: " << SO3_R <<endl;
	cout << "SO(3) form vector: " << SO3_v <<endl;
	cout << "SO(3) form quaternion: " << SO3_q <<endl;
	...
	cout << "SE3 update = " <<SE3_updated.matrix() <<endl;
